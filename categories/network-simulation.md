...
| 17 | [clab_mpls_frr](https://github.com/martimy/clab_mpls_frr) | MPLS network lab implementations using FRRouting and Containerlab. Covers manual MPLS, LDP label ... | — |
| 13 | [Clabernetes](https://github.com/srl-labs/clabernetes) | Containerlab but in Kubernetes. Deploys containerlab network topologies on K8s clusters, enabling... | Nokia |
