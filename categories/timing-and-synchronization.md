...
|------:|------|-------------|---------|
| 47 | [Time-Card](https://github.com/Time-Appliances-Project/Time-Card) | Open precision time platform and reference architecture for PTP/NTP synchronization. Covers timing d | — |
| 39 | [ntpd-rs](https://github.com/pendulum-project/ntpd-rs) | Full-featured Rust implementation of the Network Time Protocol with NTS support. Relevant for harden | — |
