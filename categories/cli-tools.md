...
| 23 | [Networking Toolbox](https://github.com/Lissy93/networking-toolbox) | Self-hosted collection of 100+ offline-first networking tools and utilities. Includes DNS lookup,... | — |
| 20 | [sig](https://github.com/ynqa/sig) | Interactive grep for streaming data. Real-time search through live data streams with TUI, command... | — |
