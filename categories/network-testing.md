...
| 27 | [Open Traffic Generator Examples](https://github.com/open-traffic-generator/otg-examples) | Software-only network test labs and examples for the Open Traffic Generator API using containerized  | — |
| 27 | [gtrace](https://github.com/hervehildenbrand/gtrace) | Advanced network path analysis tool with MPLS label parsing, ECMP detection, GlobalPing integration, | — |
